...
if(isset($_POST['submit']))
{
    ...
    $sql=mysqli_query($con,"update staff set image='$dst_db' where username='".$_SESSION['alogin']."'");
...
<head>
	...
	<title>RCA Staff| Change Profile Picture</title>
					...
					<div class="content">
						...
						<div class="module">
							<div class="module-head">
								<h3>RCA Staff Change Profile Picture</h3>
							</div>
