...
{
$sql=mysqli_query($con,"SELECT password FROM  staff where password='".$_POST['password']."' && username='".$_SESSION['alogin']."'");
$num=mysqli_fetch_array($sql);
if($num>0)
{
 $con=mysqli_query($con,"update staff set password='".$_POST['newpassword']."', updationDate='$currentTime' where username='".$_SESSION['alogin']."'");
...
<head>
	...
	<title>RCA Staff| Change Password</title>
					...
					<div class="content">
						...
						<div class="module">
							<div class="module-head">
								<h3>RCA Staff Change Password</h3>
							</div>
