...
header('location:index.php');
    ...
    $sql=mysqli_query($con,"insert into cooperative(username,image,location,production,represantation,field,password) values('$username','$image','$location','$production','$represantation','$field','$password')");
    $_SESSION['msg']="Cooperative Added Successfully !!";
...
<head>
	...
	<title>RCA Staff| Add Cooperative</title>
...
<div class="controls">
<input type="text" name="username" placeholder="Enter Cooperative Name" class="span8 tip" required>
</div>
</div>
...
<div class="controls">
<input type="text" name="location" placeholder="Enter Cooperative location" class="span8 tip" required>
</div>
</div>
<div class="control-group">
...
<input type="password" name="password" placeholder="Enter Password" class="span8 tip" required>
	...
	<div class="control-group">
											<div class="controls">
												<button type="submit" name="submit" class="btn">Add Cooperative</button>
											</div>
										</div>
									</form>
							</div>
