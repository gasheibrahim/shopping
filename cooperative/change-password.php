...
{
$sql=mysqli_query($con,"SELECT password FROM  cooperative where password='".$_POST['password']."' && username='".$_SESSION['alogin']."'");
$num=mysqli_fetch_array($sql);
if($num>0)
{
 $con=mysqli_query($con,"update cooperative set password='".$_POST['newpassword']."', updationDate='$currentTime' where username='".$_SESSION['alogin']."'");
...
<head>
	...
	<title>Cooperative| Change Password</title>
					...
					<div class="content">
						...
						<div class="module">
							<div class="module-head">
								<h3>Cooperative Change Password</h3>
							</div>
