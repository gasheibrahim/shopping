...
<div class="controls">
<input type="text"    name="quantity"  placeholder="Enter Product Quantity" value="<?php echo htmlentities($row['quantity']);?>"  class="span8 tip" required>
</div>
</div>
