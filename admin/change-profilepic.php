...
if(isset($_POST['submit']))
{
    ...
    $sql=mysqli_query($con,"update admin set image='$dst_db' where username='".$_SESSION['alogin']."'");
...
<head>
	...
	<title>Admin| Change Profile Picture</title>
					...
					<div class="content">
						...
						<div class="module">
							<div class="module-head">
								<h3>Admin Change Profile Picture</h3>
							</div>
