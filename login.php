...
<div class="col-md-6 col-sm-6 create-new-account">
	...
	<form class="register-form outer-top-xs" id="myform" role="form" method="post" name="register" onSubmit="return valid();">
<div class="form-group">
...
<div class="form-group">
	    	...
	    	<input type="tel" class="form-control unicase-form-control text-input" id="contactno"  name="contactno" maxlength="10" required>
		  </div>
		  <script>
			var phone_input = document.getElementById("contactno");
